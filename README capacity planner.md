...
Most recent linked run:

- linked asset input used: `true`
- overridden regions: `Central, Mountain, Northeast, Pacific, Southeast`
- base coverage: `91.64%`
- SLA achievement rate: `85.00%`
- total capex: `$1,184,636.80`
- total opex: `$572,340.00`
- total cost: `$1,756,976.80`
- deployment units total: `144`
- binding constraints: `109`
- solve time: `0.0707s`

Scenario highlights:

- `+20%` shock coverage: `88.25%`
- `-20%` contraction coverage: `93.83%`
- shock plan delta vs. base: `+36` deployment units
- contraction plan delta vs. base: `-44` deployment units
